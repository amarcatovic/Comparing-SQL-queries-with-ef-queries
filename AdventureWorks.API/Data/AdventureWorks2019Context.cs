using System;
using AdventureWorks.API.Data.Views;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata;

#nullable disable

namespace AdventureWorks.API.Data.Models
{
    public partial class AdventureWorks2019Context : DbContext
    {
        ...
        public virtual DbSet<VWAddress> VWAddress { get; set; }
        public virtual DbSet<VMAddressWithType> VMAddressWithType { get; set; }
        public virtual DbSet<VWPodSop> VWPodSop { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Views
            modelBuilder.Entity<VWTest>()
                .HasNoKey()
                .ToView("VW_Test");

            modelBuilder.Entity<VWAddress>()
                .HasNoKey()
                .ToView("VW_Address");

                modelBuilder.Entity<VMAddressWithType>()
                .HasNoKey();

                modelBuilder.Entity<VWPodSop>()
                .HasNoKey()
                .ToView("VW_POD_SOP");
